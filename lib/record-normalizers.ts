...
export function normalizeTrackedRun(
  ...
  return {
    ...
    mode:
      record.mode === TRACKED_RUN_MODE.ATS_SCORE
...
export function isMissingTrackedRunsTable(
...
export function isMissingJobApplicationsTable(
  error: { code?: string; message?: string } | null | undefined
) {
  return (
    error?.code === "PGRST205" ||
